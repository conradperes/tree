...
public class BTree {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            FileReader iFile = new FileReader("/Users/conradperes/Documents/Documents - ConradMac/projetos/algoritmos/patricia/src/btree/tree_operations.txt");
    ...
    public static void insertHelper(BTreeNode currentNode, Integer item, BTreeNode remainder) {
        ...
        nodeList.values().forEach(c->System.out.println(c));
    }
